          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50">
                <th className="text-left px-6 py-3 text-slate-500 font-medium">{t('common.date')}</th>
                <th className="text-left px-6 py-3 text-slate-500 font-medium">{t('recipes.ingredient')}</th>
                <th className="text-left px-6 py-3 text-slate-500 font-medium">{t('stock_in.qty')}</th>
                <th className="text-left px-6 py-3 text-slate-500 font-medium">{t('stock_in.price_total')}</th>
                <th className="text-left px-6 py-3 text-slate-500 font-medium">{t('common.note')}</th>
              </tr>
            </thead>
            <tbody>
              {purchases.map(p => (
